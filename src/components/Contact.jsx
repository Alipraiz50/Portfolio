        ...
        <div className="grid md:grid-cols-2 place-items-center">
            <div>
                <div className="text-gray-300 my-3">
                    ...
                    I am a frontend developer and all-round tech enthusiast
                    mildly obsessed with Open Source, Web Accessibility, and Automation.
                I believe in my creativity and dedication towards building excellent web applications
                    </p>
                </div>
